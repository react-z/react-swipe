...
var _swipr2 = _interopRequireDefault(require("./swipr.css"));
...
/*#__PURE__*/
function (_Component) {
  _inherits(Swipr, _Component);

  function Swipr() {
    _classCallCheck(this, Swipr);

    return _possibleConstructorReturn(this, _getPrototypeOf(Swipr).apply(this, arguments));
  }
